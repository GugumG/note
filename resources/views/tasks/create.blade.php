...
@section('content')
    <div class="form-container">
        ...
        <form action="{{ route('tasks.store') }}" method="POST" class="note-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-input @error('title') is-error @enderror" value="{{ old('title') }}" required placeholder="Masukkan judul task...">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" class="form-input @error('content') is-error @enderror" rows="5" placeholder="Tulis detail task di sini...">{{ old('content') }}</textarea>
