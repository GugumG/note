            ...
            <div class="form-group" style="margin-bottom: 24px; padding: 15px; background: rgba(148, 180, 193, 0.05); border-radius: var(--radius-md); border: 1px dashed var(--color-border);">
                ...
                <div style="display: flex; gap: 24px; flex-wrap: wrap;">
                    <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                        <input type="radio" name="visibility" value="personal" {{ old('visibility', $note->visibility) == 'personal' ? 'checked' : '' }} style="width: 20px; height: 20px; accent-color: var(--color-secondary);">
                    ...
                    <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                        <input type="radio" name="visibility" value="team" {{ old('visibility', $note->visibility) == 'team' ? 'checked' : '' }} style="width: 20px; height: 20px; accent-color: var(--color-secondary);">
                        <div style="display: flex; flex-direction: column;">
